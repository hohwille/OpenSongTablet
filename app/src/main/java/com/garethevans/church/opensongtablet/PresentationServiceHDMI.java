...
class PresentationServiceHDMI extends Presentation
    ...
    static DocumentFile img1File;
    static DocumentFile img2File;
    static String vid1File;
    static String vid2File;
    private static String vidFile;
    private static DocumentFile imgFile;
    ...
    static void setUpLogo() {
        ...
        DocumentFile customLogo = storageAccess.getFileLocationAsDocumentFile(c,homeFolder,
                "Backgrounds","", FullscreenActivity.customLogo);
    ...
    static void fixBackground() {
        StorageAccess storageAccess = new StorageAccess();
        DocumentFile homeFolder = storageAccess.getHomeFolder(c);
        img1File = storageAccess.getFileLocationAsDocumentFile(c,homeFolder,
                "Backgrounds","", FullscreenActivity.backgroundImage1);
        img2File = storageAccess.getFileLocationAsDocumentFile(c,homeFolder,
                "Backgrounds","", FullscreenActivity.backgroundImage2);
        vid1File = (storageAccess.getFileLocationAsUri(c,homeFolder,
                "Backgrounds","", FullscreenActivity.backgroundVideo1)).toString();
        vid2File = (storageAccess.getFileLocationAsUri(c,homeFolder,
                "Backgrounds","", FullscreenActivity.backgroundVideo2)).toString();
    ...
    private static class PrepareStageProjected extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                if (!cancelled) {
                    test1_1 = ProcessSong.projectedSectionView(context, homeFolder,
                            FullscreenActivity.currentSection, 12.0f);
    ...
    private static class ProjectedStageView1Col extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                if (!cancelled) {
                    lyrics1_1 = ProcessSong.projectedSectionView(context, homeFolder,
                            FullscreenActivity.currentSection, ProcessSong.getProjectedFontSize(scale));
            ...
            try {
                if (!cancelled) {
                    ...
                    for (int x = 0; x < FullscreenActivity.songSections.length; x++) {
                        ...
                        test1_1 = ProcessSong.projectedSectionView(context, homeFolder, x, 12.0f);
                        col1_1.addView(test1_1);

                        if (x < FullscreenActivity.halfsplit_section) {
                            test1_2 = ProcessSong.projectedSectionView(context, homeFolder, x, 12.0f);
                            col1_2.addView(test1_2);
                        } else {
                            test2_2 = ProcessSong.projectedSectionView(context, homeFolder, x, 12.0f);
                            col2_2.addView(test2_2);
                        }

                        if (x < FullscreenActivity.thirdsplit_section) {
                            test1_3 = ProcessSong.projectedSectionView(context, homeFolder, x, 12.0f);
                            col1_3.addView(test1_3);
                        } else if (x >= FullscreenActivity.thirdsplit_section && x < FullscreenActivity.twothirdsplit_section) {
                            test2_3 = ProcessSong.projectedSectionView(context, homeFolder, x, 12.0f);
                            col2_3.addView(test2_3);
                        } else {
                            test3_3 = ProcessSong.projectedSectionView(context, homeFolder, x, 12.0f);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                if (!cancelled) {
                    ...
                    // Go through each section
                    for (int x = 0; x < FullscreenActivity.songSections.length; x++) {
                        lyrics1_1 = ProcessSong.projectedSectionView(context, homeFolder, x, fontsize1_1);
                        LinearLayout.LayoutParams llp1_1 = new LinearLayout.LayoutParams(availableWidth_1col, LinearLayout.LayoutParams.WRAP_CONTENT);
                        llp1_1.setMargins(0, 0, 0, 0);
                        lyrics1_1.setLayoutParams(llp1_1);
            ...
            try {
                if (!cancelled) {
                    ...
                    for (int x = 0; x < FullscreenActivity.songSections.length; x++) {
                        ...
                        if (x < FullscreenActivity.halfsplit_section) {
                            lyrics1_2 = ProcessSong.projectedSectionView(context, homeFolder, x, fontsize1_2);
                            ...
                            lyrics2_2 = ProcessSong.projectedSectionView(context, homeFolder, x, fontsize2_2);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                if (!cancelled) {
                    ...
                    for (int x = 0; x < FullscreenActivity.songSections.length; x++) {
                        if (x < FullscreenActivity.thirdsplit_section) {
                            lyrics1_3 = ProcessSong.projectedSectionView(context, homeFolder, x, fontsize1_3);
                            ...
                            lyrics2_3 = ProcessSong.projectedSectionView(context, homeFolder, x, fontsize2_3);
                            ...
                            lyrics3_3 = ProcessSong.projectedSectionView(context, homeFolder, x, fontsize3_3);
