...
public class PopUpProfileFragment extends DialogFragment {
    ...
    DocumentFile location, homeFolder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        okSave_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!name.equals("")) {
                    DocumentFile myfile = sa.getFileLocationAsDocumentFile(getActivity(), homeFolder,
                            "Profiles","",name);
                    try {
                        OutputStream overWrite = sa.getOutputStreamFromUri(getActivity(),myfile.getUri());
                        sa.writeBytes(getActivity(),overWrite,contents.getBytes());
    ...
    public void setupProfileList() {
        StorageAccess sa = new StorageAccess();
        location = sa.tryCreateDirectory(getActivity(),homeFolder,"Profiles","");
    ...
    public void grabvalues(String file) throws Exception {
        ...
        StorageAccess sa = new StorageAccess();
        DocumentFile loadprofile = sa.getFileLocationAsDocumentFile(getActivity(), homeFolder,
                "Profiles","",file);
        ...
        InputStream inputStream = sa.getInputStreamFromUri(getActivity(),loadprofile.getUri());
